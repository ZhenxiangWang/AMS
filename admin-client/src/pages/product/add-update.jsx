  ...
  submit = () => {
    ...
    this.props.form.validateFields(async (error, values) => {
      if (!error) {
        ...
        if (result.status === 0) {
          message.success(
            `${this.isUpdate ? "Update" : "Delete"}item success!`
          );
          this.props.history.goBack();
        } else {
          message.error(`${this.isUpdate ? "Update" : "Add"}item failed!`);
        }
      }
    });
  };
  ...
  render() {
    ...
    const title = (
      <span>
        ...
        <span>{isUpdate ? "EDIT ITEM" : "ADD ITEM"}</span>
      </span>
    );
        ...
        <Form {...formItemLayout}>
          ...
          <Item label="CATEGORY">
            {getFieldDecorator("categoryIds", {
              ...
              <Cascader
                placeholder="Please input item category"
